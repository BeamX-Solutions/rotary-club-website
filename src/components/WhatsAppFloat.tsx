  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-4">
        ...
        {isOpen && (
          <div
            className="w-96 bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col animate-in fade-in slide-in-from-bottom-4 duration-300"
              ...
              {selectedContact ? (
                ...
                <div className="divide-y divide-gray-100">
                  {contacts.map((contact) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#128C7E] to-[#25D366] flex-shrink-0 group-hover:scale-110 transition-transform" />
